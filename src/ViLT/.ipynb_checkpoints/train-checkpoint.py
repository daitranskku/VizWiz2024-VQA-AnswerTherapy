...
model_folder = os.path.join('/DATA2/Han/VizWiz/ViLT', pretrained_model)
finetune_folder = os.path.join('/DATA2/Han/VizWiz/ViLT/my_finetune', "using__" + pretrained_model)
...
if __name__ == "__main__":
    ...
    # Inference
    # input_img = Image.open('/DATA2/Han/VizWiz/ViLT/pic2.jpg')
    # input_text = "What are they doing?"
    # output_text = inference(input_img, input_text)
    # print("Predicted answer:", output_text)
    # visualize_text = f"{input_text}: {output_text}"
    # visualize_prediction(input_img, visualize_text, 'output_pic2_1.jpg')
