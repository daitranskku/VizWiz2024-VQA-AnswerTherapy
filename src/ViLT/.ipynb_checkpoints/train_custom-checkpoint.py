...
files = os.listdir('/SSD/data/HoangVN/VQA_therapy/dataset/train')
val_files = os.listdir('/SSD/data/HoangVN/VQA_therapy/dataset/train')
...
model_folder = os.path.join('/SSD/data/HoangVN/VQA_therapy/ViLT', pretrained_model)
finetune_folder = os.path.join('/SSD/data/HoangVN/VQA_therapy/ViLT/my_finetune', "custom_vqa_" + pretrained_model)
...
if __name__ == "__main__":
    ...
    #     input_img = Image.open('/SSD/1_Postdoc_SKKU_2023/Research/2024_vqa_res/workshop/src/vqa_therapy/demo/pic2.jpg')
    #     input_text = "What are they doing?"
    #     output_texts = inference(input_img, input_text)
    #     print("Predicted answer:", output_text)
    #     visualize_prediction(image=input_img, input_text, output_texts, save_img=True)
